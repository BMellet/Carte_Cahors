...
function initMap() {
    ...
    MapBounds = new google.maps.LatLngBounds(new google.maps.LatLng(44.60904581939581, 1.7481994628906252), new google.maps.LatLng(44.30714395830852, 1.1295318603515627));
}
...
function initMarkers(places, sub, parent) {
    ...
    places.forEach(function (item) {
        ...
        var infowindow = new google.maps.InfoWindow({
            content: '<div class="infoWindow">' + '<h5>' + item.name + '</h5>' + '<h6>' + item.description + '</h6>' + '</div>'
        });
